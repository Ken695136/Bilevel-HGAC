...
from model.non_local import NLGNN
...
class MAGNN_nc_AC(nn.Module):
    def __init__(self,
        ...
        self.higher_order_matrix = highorder_matrix
        ...
        # self.non_local_net =NLGNN(self.window_size,self.hidden_dim)
    ...
    def forward(self, inputs_1, inputs_2):
        #feat_keep_idx, feat_drop_idx都不用
        ...
        for i, opt in enumerate(self.feat_opt):
            if opt == 1:
                feat_ac = self.hgnn_ac(self.higher_order_matrix[mask_list[i]][:, mask_list[node_type_src]],
