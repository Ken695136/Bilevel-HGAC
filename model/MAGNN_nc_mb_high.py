...
class MAGNN_nc_mb_AC(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        feature_src_re = self.hgnn_ac(self.higher_order_matrix[mask_list[node_type_src]][:, mask_list[node_type_src]][:, feat_keep_idx],
        ...
        for i, opt in enumerate(self.feat_opt):
            if opt == 1:
                ...
                # feat_ac = self.hgnn_ac(self.higher_order_matrix[mask_list[i]],
                #                        emb[mask_list[i]], emb,
                #                        feat_src)
