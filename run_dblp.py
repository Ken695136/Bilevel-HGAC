...
from utils.higher_order import embedding_adj_dblp
...
ap.add_argument('--feats-opt', type=str, default='1011', help='010 means 1 type nodes use our processed feature.')
...
ap.add_argument('--w_decay',type = float,default=0.001,help='weight decay of HGNN parameter')
...
with torch.autograd.set_detect_anomaly(True):
    ...
    # if high_mode == 'pagerank':
    #     pagerank_result = np.array(pagerank(adjM))
    #     higher_order_matrix = adjM + pagerank_result
    higher_order_matrix = embedding_adj_dblp(emb, topk)
    # higher_order_matrix = adjM + emb_adj
